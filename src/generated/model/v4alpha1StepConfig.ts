 ...
 */
export class V4alpha1StepConfig {
  /**
   ...
   */
  "params"?: { [key: string]: StepConfigParameterConfigs };
  /**
   * Mapping of identifier to list of changes to apply.
   */
  "consts"?: { [key: string]: StepConfigConstantConfigs };
  /**
  ...
  static attributeTypeMap: Array<{
    ...
    },
    {
      name: "params",
      baseName: "params",
      type: "{ [key: string]: StepConfigParameterConfigs; }",
    },
    {
      name: "consts",
      baseName: "consts",
      type: "{ [key: string]: StepConfigConstantConfigs; }",
    },
    {
      name: "condition",
      baseName: "condition",
  ...
  static getAttributeTypeMap() {
    return V4alpha1StepConfig.attributeTypeMap;
  }
}
