...
export class V4alpha1QueryCollectionResponse {
  "pipeline"?: V4alpha1QueryCollectionResponsePipeline;
  /**
  ...
  static attributeTypeMap: Array<{
  ...
  }> = [
    {
      name: "pipeline",
      baseName: "pipeline",
      type: "V4alpha1QueryCollectionResponsePipeline",
    },
    {
      name: "variables",
      baseName: "variables",
  ...
  static getAttributeTypeMap() {
    return V4alpha1QueryCollectionResponse.attributeTypeMap;
  }
}
