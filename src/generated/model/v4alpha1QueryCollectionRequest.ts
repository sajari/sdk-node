 ...
 */
export class V4alpha1QueryCollectionRequest {
  "pipeline"?: V4alpha1QueryCollectionRequestPipeline;
  /**
  ...
  static attributeTypeMap: Array<{
  ...
  }> = [
    {
      name: "pipeline",
      baseName: "pipeline",
      type: "V4alpha1QueryCollectionRequestPipeline",
    },
    {
      name: "variables",
      baseName: "variables",
  ...
  static getAttributeTypeMap() {
    return V4alpha1QueryCollectionRequest.attributeTypeMap;
  }
}
