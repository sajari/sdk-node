...
export class V4BatchUpsertRecordsResponse {
  /**
   ...
   */
  "keys"?: Array<V4BatchUpsertRecordsResponseKey>;
  /**
   ...
   */
  "errors"?: Array<V4BatchUpsertRecordsResponseError>;
  ...
  static attributeTypeMap: Array<{
  ...
  }> = [
    {
      name: "keys",
      baseName: "keys",
      type: "Array<V4BatchUpsertRecordsResponseKey>",
    },
    {
      name: "variables",
      baseName: "variables",
    ...
    },
    {
      name: "errors",
      baseName: "errors",
      type: "Array<V4BatchUpsertRecordsResponseError>",
    },
  ];

  static getAttributeTypeMap() {
    return V4BatchUpsertRecordsResponse.attributeTypeMap;
  }
}
