...
export class V4UpsertRecordRequest {
  "pipeline"?: V4UpsertRecordRequestPipeline;
  /**
  ...
  static attributeTypeMap: Array<{
  ...
  }> = [
    {
      name: "pipeline",
      baseName: "pipeline",
      type: "V4UpsertRecordRequestPipeline",
    },
    {
      name: "record",
      baseName: "record",
  ...
  static getAttributeTypeMap() {
    return V4UpsertRecordRequest.attributeTypeMap;
  }
}
