 ...
 */
export class V4QueryCollectionRequest {
  "pipeline"?: V4QueryCollectionRequestPipeline;
  /**
   ...
   */
  "variables": object;
  "tracking"?: V4QueryCollectionRequestTracking;
  ...
  static attributeTypeMap: Array<{
  ...
  }> = [
    {
      name: "pipeline",
      baseName: "pipeline",
      type: "V4QueryCollectionRequestPipeline",
    },
    {
      name: "variables",
      baseName: "variables",
    ...
    },
    {
      name: "tracking",
      baseName: "tracking",
      type: "V4QueryCollectionRequestTracking",
    },
  ];

  static getAttributeTypeMap() {
    return V4QueryCollectionRequest.attributeTypeMap;
  }
}
